...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath : '../../images/admin/nicEditorIcons.gif',
	buttonList : ['save','bold','italic','underline','left','center','right','justify','ol','ul','link','unlink','forecolor','bgcolor'],
...
var nicEditors = {
	...
	allTextAreas : function(nicOptions) {
        var textareas = document.getElementsByClassName("nicedit");
...
var nicEditorInstance = bkClass.extend({
	...
	construct : function(e,options,nicEditor) {
		...
		if(isTextarea || this.options.hasPanel) {
			...
			var editorElm = new bkElement('DIV').setStyle({width : '100%'}).addClass('main').appendTo(this.editorContain);
...
var nicEditorIFrameInstance = nicEditorInstance.extend({
	...
	init : function() {	
		...
		if(this.copyElm) { this.elmFrame.setStyle({width : '100%'}); }
...
var nicEditorButton = bkClass.extend({
	...
	setBg : function(state) {
		this.border.addClass('button-'+state);
	},
