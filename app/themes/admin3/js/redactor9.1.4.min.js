...
RedactorPlugins.pre = {
    init: function ()
    {
        var codes = [ 'php', 'css', 'javascript', 'ruby'];
        var that = this;
        var dropdown = {};

        $.each(codes, function(i, s)
        {
            dropdown['s' + i] = { title: s, callback: function() { that.setCodeType(s); }};
        });

        this.buttonAdd('pre', 'Add Code Block', false, dropdown);
    },
    setCodeType: function (value)
    {
        //this.inlineSetStyle('font-family', value);
        this.formatBlocks('pre');
        this.blockSetClass('code-block language-' + value);
